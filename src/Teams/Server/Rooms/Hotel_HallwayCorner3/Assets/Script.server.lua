...
local v5 = script.Parent.Window2
local v6 = script.Parent.Window3
		...
		while true do
			...
			coroutine.wrap(function()
				delay(math.random(0, 10) / 100, function()
					...
					l__TweenService__1:Create(v6.LightPanel.Lightning, TweenInfo.new(0.065, Enum.EasingStyle.Back, Enum.EasingDirection.InOut, 3, true, 0), {
						Brightness = 2
					}):Play();
					...
					v6.LightPanel.Attachment.Thunder.Pitch = 1 + math.random(-100, 100) / 1000;
					v6.LightPanel.Attachment.Thunder:Play();
